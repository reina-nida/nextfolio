  ...
  return (
    <section className="mb-32 flex w-full justify-center">
      ...
      <div className="flex flex-col gap-5 rounded-xl border border-white/20 bg-white/20 p-10 shadow-lg backdrop-blur-md transition-all duration-300 hover:bg-white/30 hover:shadow-xl">
        <p className="text-2xl font-bold text-black drop-shadow">Stack</p>

        {/* Deskripsi singkat tentang isi bagian Stack */}
        <p className="max-w-md text-justify text-sm text-black/90">
        ...
        <div className="flex flex-col gap-2">
          <p className="text-sm font-semibold text-black/90">Frameworks & Libraries</p>
        ...
        <div className="flex flex-col gap-2">
          <p className="text-sm font-semibold text-black/90">Tools</p>
